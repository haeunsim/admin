...
import { FilterArea, Flex, RadioCell } from "../assets/styles/CommonStyles";
...
const Button = styled.button`
  ...
  color: #292929;
  padding: 8px;
  background-color: ${(props) => (props.primary ? "#2E90FF" : "#f3f3f3")};
  color: ${(props) => (props.primary ? "#fff" : "#292929")};
`;
...
const ContentCreation = () => {
  ...
  const 유형 = ["아이스브레이킹", "학습용어", "학습활동", "학습개념어"];

  const 출제방식 = ["단답형", "서술형", "선택형", "진위형", "초성"];
  ...
  return (
    <Container
      title="[디폴트] 생성/업로드"
      subtitle="교사 LMS에서 열람 가능한 '완성형 채팅수업 콘텐츠(복수의 질문/대답set 조합)을 직접 생성/관리하는 페이지입니다."
    >
      <div>
        <TabList>
        ...
        <TabContent>
          ...
          <div>
            <div style={{ display: "flex", justifyContent: "end" }}>
              <span style={{ color: "#2E90FF" }}>
                저장한 질문 & 대답은 '채팅 콘텐츠 생성' 탭에서 확인 가능합니다.
              </span>
            </div>

            <div>
              <h5># 1. 직접 입력하기</h5>
              <Flex style={{ width: "460px", marginTop: "20px" }}>
                <Dropdown
                  label="유형"
                  options={유형}
                  value={selectedUnit}
              ...
              <Flex style={{ marginTop: "20px" }}>
                <div style={{ width: "60%", height: "60px" }}>
                  <Textarea maxLength={255} placeholder="질문 입력란" />
                </div>
                <div style={{ width: "40%", height: "60px" }}>
                  <Textarea maxLength={255} placeholder="대답 입력란" />
                </div>
              </Flex>
